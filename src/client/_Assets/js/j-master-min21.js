!(function (e) {
    ...
    var o = /\+/g,
        n = (e.cookie = function (o, a, r) {
            ...
            for (var c = o ? void 0 : {}, p = document.cookie ? document.cookie.split("; ") : [], u = 0, h = p.length; h > u; u++) {
                var f = p[u].split("="),
                    m = i(f.shift()),
                    v = f.join("=");
                if (o && o === m) {
    ...
    $(".accept-close").click(function () {
        $.cookie("visited", "yes", { expires: 30 }), $(this).parent().parent().parent(".notification-bar").remove();
    }),
    $("header .popup-close").click(function () {
        $("body").addClass("notification-close"), $.cookie("headerNotification", "yes", { expires: 7 });
    }),
    $(document).ready(function () {
        $('.first:has(".panel-wrap")').on("keyup click", function (e) {
            9 === e.keyCode && ($(this).children("a").addClass("open").attr("aria-expanded", !0), $(".panel-wrap").removeClass("open"), $(this).children(".panel-wrap").addClass("open").attr("aria-expanded", !0).attr("aria-hidden", !1));
        }),
            $(".first")
                .not(':has(".panel-wrap")')
                .on("keyup not click", function (e) {
                    9 === e.keyCode &&
                        ($(this).children("a").addClass("open").attr("aria-expanded", !0), $(".panel-wrap").removeClass("open"), $(this).children(".panel-wrap").addClass("open").attr("aria-expanded", !0).attr("aria-hidden", !1));
                }),
            ...
            "yes" != $.cookie("visited") ? $("footer .notification-bar").removeClass("hide") : $("footer .notification-bar").removeClass("hide").addClass("hide"),
            ($.fn.capitalize = function () {
                return (
                    $.each(this, function () {
                        for (var e = this.value.split(" "), t = 0, i = e.length; t < i; t++) e[t] = e[t].charAt(0).toUpperCase() + e[t].slice(1).toLowerCase();
                        this.value = e.join(" ");
                    }),
                    this
                );
            ...
            $(".dial-us input[type='tel']").length && $(".dial-us input[type='tel']").attr("onkeydown", "javascript:backspacerDOWN(this,event);").attr("onkeyup", "javascript:backspacerUP(this,event);"),
            $.validator.addMethod(
                "alphabetFormat",
                function (e, t) {
            ...
            $("#sales-question").validate({
                rules: {
                    first_name: { required: !0, minlength: 2, alphabetFormat: !0, hasLowercase: !0, notEqual: [".std-input3"] },
                    last_name: { required: !0, minlength: 2, alphabetFormat: !0, hasLowercase: !0, notEqual: [".std-input3"] },
                ...
                messages: {
                    ...
                    company: { minlength: "Company name must consist of at least 3 characters", alphabetFormat: "No special characters.", hasLowercase: "Please do not use all caps." },
                    job_title: { minlength: "Job Title must consist of at least 3 characters", hasLowercase: "Please do not use all caps." },
                    phone: { required: "Please enter your phone number.(XXX) XXX-XXXX", minlength: "Your phone number must consist of at least 7 characters" },
                    email: "Please enter a valid email address",
                    State: "Please select your State",
                    permission_received: "This checkbox is required.",
                    Sales_Question: { required: "Please enter your question", minlength: "Your question must consist of at least 5 characters" },
                },
            });
    }),
    $(window).load(function () {
        ...
        $(window).keydown(function (i) {
            40 === i.which
                ? e
                    ? (e.removeClass("key-selected"), (next = e.next()), (e = next.length > 0 ? next.addClass("key-selected") : t.eq(0).addClass("key-selected")))
                    : (e = t.eq(0).addClass("key-selected"))
                : 38 === i.which && (e ? (e.removeClass("key-selected"), (next = e.prev()), (e = next.length > 0 ? next.addClass("key-selected") : t.last().addClass("key-selected"))) : (e = t.last().addClass("key-selected")));
        });
    }),
    $(document).ready(function () {
        $("#subscribe-form").validate({ rules: { email: { required: !0, email: !0 } }, messages: { email: { required: "Please enter a valid email address" } } }),
            ...
            window.location.href.indexOf("b309b5f2-3dd0-40b1-92c0-c0c605ff664e") > -1 &&
                ($("#subscribe-form").addClass("hide"), $(".thank-you").removeClass("hide"), $("html, body").animate({ scrollTop: $("#popup-fixed").offset().top - 150 }, "fast")),
            $("#subscribe-form").submit(function () {
                $.ajax({
                    ...
                    success: function () {
                        $("#subscribe-form").addClass("hide"), $(".thank-you").removeClass("hide");
                    },
                });
            }),
            $("#subscribe-form-body").validate({ rules: { email: { required: !0, email: !0 } }, messages: { email: { required: "Please enter a valid email address" } } }),
            $("#subscribe-form-body :input").focus(function () {
                $(this).parent().addClass("valid-group").children("label.label-focus").removeClass("label-focus").addClass("label-blur");
            }),
            window.location.href.indexOf("WcoFormId=e03e8096-9bb4-4cf4-9006-1d86466b63a2") > -1 &&
                ($("#subscribe-form-body").addClass("hide"), $("#thank-you-body").removeClass("hide"), $("html, body").animate({ scrollTop: $("#subscribe-body-anchor").offset().top - 150 }, "fast")),
            $("#subscribe-form-body").submit(function () {
                $.ajax({
                    ...
                    success: function () {
                        $("#subscribe-form-body").addClass("hide"), $(".thank-you-body").removeClass("hide");
                    },
                });
            }),
            $("#form-download").validate({
                rules: { first_name: { required: !0, minlength: 3 }, last_name: { required: !0, minlength: 3 }, email: { required: !0, email: !0 } },
                messages: {
                    first_name: { required: "Please enter your first name", minlength: "Your first name must consist of at least 3 characters" },
                    last_name: { required: "Please enter your last name", minlength: "Your last name must consist of at least 3 characters" },
                    email: "Please enter a valid email address",
                },
            });
    }),
...
var num = $("#section-1").length > 0 ? $('[id^="section-"]:not("#section-1")')[0] : $('[id^="section-"]');
        ...
        ((t = (function () {
            ...
            (t.prototype.changeSlide = function (t, i) {
                var s,
                    ...
                    n = this,
                    a = e(t.currentTarget);
                switch ((a.is("a") && t.preventDefault(), a.is("li") || (a = a.closest("li")), (s = n.slideCount % n.options.slidesToScroll != 0 ? 0 : (n.slideCount - n.currentSlide) % n.options.slidesToScroll), t.data.message)) {
                    case "previous":
            ...
            (t.prototype.getLeft = function (e) {
                ...
                return (
                    ...
                    !0 === o.options.infinite
                        ? (o.slideCount > o.options.slidesToShow && ((o.slideOffset = o.slideWidth * o.options.slidesToShow * -1), (n = i * o.options.slidesToShow * -1)),
                          o.slideCount % o.options.slidesToScroll != 0 &&
                              e + o.options.slidesToScroll > o.slideCount &&
                              o.slideCount > o.options.slidesToShow &&
                              (e > o.slideCount
                                  ? ((o.slideOffset = (o.options.slidesToShow - (e - o.slideCount)) * o.slideWidth * -1), (n = (o.options.slidesToShow - (e - o.slideCount)) * i * -1))
                                  : ((o.slideOffset = (o.slideCount % o.options.slidesToScroll) * o.slideWidth * -1), (n = (o.slideCount % o.options.slidesToScroll) * i * -1))))
                        : e + o.options.slidesToShow > o.slideCount && ((o.slideOffset = (e + o.options.slidesToShow - o.slideCount) * o.slideWidth), (n = (e + o.options.slidesToShow - o.slideCount) * i)),
                    o.slideCount <= o.options.slidesToShow && ((o.slideOffset = 0), (n = 0)),
                    !0 === o.options.centerMode && !0 === o.options.infinite
                        ? (o.slideOffset += o.slideWidth * Math.floor(o.options.slidesToShow / 2) - o.slideWidth)
                        : !0 === o.options.centerMode && ((o.slideOffset = 0), (o.slideOffset += o.slideWidth * Math.floor(o.options.slidesToShow / 2))),
                    (t = !1 === o.options.vertical ? e * o.slideWidth * -1 + o.slideOffset : e * i * -1 + n),
            ...
            (t.prototype.lazyLoad = function () {
                ...
                !0 === s.options.centerMode
                    ? !0 === s.options.infinite
                        ? (i = (t = s.currentSlide + (s.options.slidesToShow / 2 + 1)) + s.options.slidesToShow + 2)
                        : ((t = Math.max(0, s.currentSlide - (s.options.slidesToShow / 2 + 1))), (i = s.options.slidesToShow / 2 + 1 + 2 + s.currentSlide))
                    : ((t = s.options.infinite ? s.options.slidesToShow + s.currentSlide : s.currentSlide), (i = Math.ceil(t + s.options.slidesToShow)), !0 === s.options.fade && (t > 0 && t--, i <= s.slideCount && i++)),
                    ...
                    ? ((i = a.first()),
                      ...
                      (o.onerror = function () {
                          t < 3
                              ...
                              : (i.removeAttr("data-lazy").removeClass("slick-loading").addClass("slick-lazyload-error"), n.$slider.trigger("lazyLoadError", [n, i, s]), n.progressiveLazyLoad());
                      }),
                      (o.src = s))
...
var swfobject = (function () {
    var e = "undefined",
        ...
        h = !1,
        f = (function () {
            var i = typeof n.getElementById != e && typeof n.getElementsByTagName != e && typeof n.createElement != e && typeof n.appendChild != e && typeof n.replaceChild != e && typeof n.removeChild != e && typeof n.cloneNode != e,
                s = [0, 0, 0],
                r = null;
            if (typeof a.plugins != e && typeof a.plugins["Shockwave Flash"] == t)
                (r = a.plugins["Shockwave Flash"].description) &&
                    ...
                    (s[2] = /r/.test(r) ? parseInt(r.replace(/^.*r(.*)$/, "$1"), 10) : 0));
                ...
                try {
                    ...
                    try {
                        (l = new ActiveXObject("ShockwaveFlash.ShockwaveFlash.6")), (s = [6, 0, 21]), (l.AllowScriptAccess = "always");
                    } catch (e) {
                        6 == s[0] && (d = !0);
                    }
                    if (!d)
                ...
                if (!d && l)
                    try {
                        (r = l.GetVariable("$version")) && ((r = r.split(" ")[1].split(",")), (s = [parseInt(r[0], 10), parseInt(r[1], 10), parseInt(r[2], 10)]));
                    } catch (e) {}
            }
            var c = a.userAgent.toLowerCase(),
                p = a.platform.toLowerCase();
            return { w3cdom: i, pv: s, webkit: !!/webkit/.test(c) && parseFloat(c.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")), ie: !1, win: /win/.test(p || c), mac: /mac/.test(p || c) };
        })();
    function m() {
        if (!u) {
            if (f.ie && f.win) {
    ...
    function b() {
        for (var e = l.length, t = 0; t < e; t++) {
            ...
            if (f.pv[0] > 0) {
                var s = S(i);
                s &&
                    ((l[t].width = s.getAttribute("width") ? s.getAttribute("width") : "0"),
                    (l[t].height = s.getAttribute("height") ? s.getAttribute("height") : "0"),
                    A(l[t].swfVersion) ? (f.webkit && f.webkit < 312 && y(s), E(i, !0)) : l[t].expressInstall && !h && A("6.0.65") && (f.win || f.mac) ? $(l[t]) : w(s));
            } else E(i, !0);
        }
    }
    function y(e) {
        ...
        if (i) {
            var s = x("embed"),
                o = i.attributes;
            if (o) for (var n = o.length, a = 0; a < n; a++) "data" == o[a].nodeName.toLowerCase() ? s.setAttribute("src", o[a].nodeValue) : s.setAttribute(o[a].nodeName, o[a].nodeValue);
            var r = i.childNodes;
            if (r) for (var l = r.length, d = 0; d < l; d++) 1 == r[d].nodeType && "param" == r[d].nodeName.toLowerCase() && s.setAttribute(r[d].getAttribute("name"), r[d].getAttribute("value"));
    ...
    function $(e) {
        ...
        if (t) {
            ...
            var a = f.ie && f.win ? "ActiveX" : "PlugIn",
                r = n.title,
                l = "MMredirectURL=" + o.location + "&MMplayerType=" + a + "&MMdoctitle=" + r,
                d = e.id;
            ...
            C({ data: e.expressInstall, id: s, width: e.width, height: e.height }, { flashvars: l }, d);
        }
    }
    function w(e) {
    ...
    function k(e) {
        ...
        if (f.win && f.ie) i.innerHTML = e.innerHTML;
            ...
            if (s) {
                var o = s.childNodes;
                if (o) for (var n = o.length, a = 0; a < n; a++) (1 == o[a].nodeType && "param" == o[a].nodeName.toLowerCase()) || 8 == o[a].nodeType || i.appendChild(o[a].cloneNode(!0));
            }
        }
        return i;
    }
    function C(s, n, a) {
        ...
        if ((typeof s.id == e && (s.id = a), f.ie && f.win)) {
            var d = "";
            for (var c in s) s[c] != Object.prototype[c] && ("data" == c ? (n.movie = s[c]) : "styleclass" == c.toLowerCase() ? (d += ' class="' + s[c] + '"') : "classid" != c && (d += " " + c + '="' + s[c] + '"'));
            var p = "";
            for (var u in n) n[u] != Object.prototype[u] && (p += '<param name="' + u + '" value="' + n[u] + '" />');
            (l.outerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + d + ">" + p + "</object>"),
                (function (e) {
                    f.ie &&
                        f.win &&
                        A("8.0.0") &&
                        o.attachEvent("onunload", function () {
                            var t = S(e);
                            if (t) {
                                for (var i in t) "function" == typeof t[i] && (t[i] = function () {});
                                t.parentNode.removeChild(t);
                            }
                        });
                })(s.id),
            ...
            for (var m in (h.setAttribute("type", i), s))
                s[m] != Object.prototype[m] && ("data" == m ? h.setAttribute("src", s[m]) : "styleclass" == m.toLowerCase() ? h.setAttribute("class", s[m]) : "classid" != m && h.setAttribute(m, s[m]));
            for (var v in n) n[v] != Object.prototype[v] && "movie" != v && h.setAttribute(v, n[v]);
            l.parentNode.replaceChild(h, l), (r = h);
        } else {
            var g = x(t);
            for (var b in (g.setAttribute("type", i), s)) s[b] != Object.prototype[b] && ("styleclass" == b.toLowerCase() ? g.setAttribute("class", s[b]) : "classid" != b && g.setAttribute(b, s[b]));
            for (var y in n) n[y] != Object.prototype[y] && "movie" != y && T(g, y, n[y]);
    ...
    function A(e) {
        var t = f.pv,
            i = e.split(".");
        return (i[0] = parseInt(i[0], 10)), (i[1] = parseInt(i[1], 10)), (i[2] = parseInt(i[2], 10)), t[0] > i[0] || (t[0] == i[0] && t[1] > i[1]) || (t[0] == i[0] && t[1] == i[1] && t[2] >= i[2]);
    }
    function O(i, s) {
        if (!f.ie || !f.mac) {
            ...
            if (
                ...
                (f.ie && f.win) || typeof n.createTextNode == e || a.appendChild(n.createTextNode(i + " {" + s + "}")),
                o.appendChild(a),
                    ...
                    try {
                        ...
                        t &&
                            (t.onreadystatechange = function () {
                                "complete" == this.readyState && (this.parentNode.removeChild(this), m());
                            });
                    } catch (e) {}
                f.webkit &&
                    ...
                    typeof n.addEventListener != e && n.addEventListener("DOMContentLoaded", m, null),
                    g(m);
            }
        })(),
        {
                    ...
                    var s = document.getElementById(e),
                        o = (function (e) {
                            ...
                            for (var t = e.childNodes, i = t.length, s = 0; s < i; s++)
                                if (
                                    (1 == t[s].nodeType && "object" == t[s].nodeName.toLowerCase() && ((i = (t = t[s].childNodes).length), (s = 0)),
                                    1 == t[s].nodeType && "param" == t[s].nodeName.toLowerCase() && "expressinstall" == t[s].getAttribute("name"))
                                )
                        ...
                        (n.swfVersion =
                            ...
                            (function (e) {
                                ...
                                for (var t = e.childNodes, i = t.length, s = 0; s < i; s++)
                                    if (
                                        (1 == t[s].nodeType && "object" == t[s].nodeName.toLowerCase() && ((i = (t = t[s].childNodes).length), (s = 0)),
                                        1 == t[s].nodeType && "param" == t[s].nodeName.toLowerCase() && "swfversion" == t[s].getAttribute("name"))
                                    )
                                        return t[s].getAttribute("value");
                                return 0;
                            })(s)),
            ...
            getObjectById: function (i) {
                ...
                if (f.w3cdom && u) {
                    ...
                    if (o) {
                        ...
                        !n || (n && typeof o.SetVariable != e) ? (s = o) : typeof n.SetVariable != e && (s = n);
                    }
                }
                return s;
            },
            embedSWF: function (i, s, o, n, a, r, l, d, c) {
                if (f.w3cdom && i && s && o && n && a)
                    if (((o += ""), (n += ""), A(a))) {
                        ...
                        var u = typeof d == t ? d : {};
                        if (typeof l == t) for (var m in l) l[m] != Object.prototype[m] && (typeof u.flashvars != e ? (u.flashvars += "&" + m + "=" + l[m]) : (u.flashvars = m + "=" + l[m]));
                        v(function () {
                        ...
                        r &&
                            ...
                            v(function () {
                                var e = {};
                                (e.id = e.altContentId = s), (e.width = o), (e.height = n), (e.expressInstall = r), $(e);
                            }));
            },
            ...
            getQueryParamValue: function (e) {
                ...
                if (null == e) return t;
                if (t) for (var i = t.substring(1).split("&"), s = 0; s < i.length; s++) if (i[s].substring(0, i[s].indexOf("=")) == e) return i[s].substring(i[s].indexOf("=") + 1);
                return "";
            },
            expressInstallCallback: function () {
                if (h && c) {
                    var e = S(s);
                    e && (e.parentNode.replaceChild(c, e), p && (E(p, !0), f.ie && f.win && (c.style.display = "block")), (c = null), (p = null), (h = !1));
                }
            },
        }
    );
...
function sticky_relocate() {
    var e = $(window).scrollTop(),
        t = $("#sticky-anchor");
    t.length && (e > t.offset().top - 80 ? ($(".search-bar").addClass("stick"), $("#sticky-anchor").height($(".search-bar").outerHeight())) : ($(".search-bar").removeClass("stick"), $("#sticky-anchor").height(0)));
}
!(function (e) {
    "use strict";
        ...
        o = function (t) {
            ...
            return (
                i.each(function () {
                    ...
                    null === a ? n.push(t) : Math.floor(Math.abs(o - i)) <= 1 ? (n[n.length - 1] = a.add(t)) : n.push(t), (o = i);
                }),
                n
            );
        },
                ...
                e.each(d, function (t, i) {
                    ...
                    o.each(function () {
                        ...
                        (r.target && t.is(r.target)) ||
                            ("border-box" !== t.css("box-sizing") && ((i += s(t.css("border-top-width")) + s(t.css("border-bottom-width"))), (i += s(t.css("padding-top")) + s(t.css("padding-bottom")))), t.css(r.property, n - i + "px"));
                    });
                }),
                u.each(function () {
                    var t = e(this);
    ...
    $(function () {
        $(".home-slider").slick({ arrows: !1, infinite: !0, autoplay: !0, pauseOnFocus: !1, dots: !0, fade: !0, autoplaySpeed: 6e3, speed: 400 }),
            ...
            $(".partner-companies-carousel").slick({
                ...
                slidesToScroll: 1,
                responsive: [
                    { breakpoint: 1024, settings: { slidesToShow: 4, slidesToScroll: 1, infinite: !0, autoplay: !0 } },
            ...
            $(".mobile-carousel").slick({ dots: !0, arrows: !1, infinite: !1, speed: 300, slidesToShow: 1, slidesToScroll: 1 }),
            ...
            $(".tab-links ul li a").on("click", function () {
                $(this).parent("li").removeClass("open").addClass("open"), $(this).parent("li").siblings("li").removeClass("open");
                var e = $(this).attr("href");
                return $(e).siblings("div.tab-detail").hide(), $(e).show(), !1;
            }),
            $(".contact-tabs ul li a").on("click", function () {
                $(this).parent("div").parent("li").removeClass("open").addClass("open"), $(this).parent("div").parent("li").siblings("li").removeClass("open");
                var e = $(this).attr("href");
                return $(e).siblings("div.tab-detail").hide(), $(e).show(), !1;
            }),
            $(".mobile-select ul li a").on("click", function () {
                ...
                var e = $(this).text();
                $(this).parent("li").parent("ul").siblings("div").children("span.drtext").text(e), $(this).parent("li").toggleClass("open"), $(this).parent("li").siblings("li").removeClass("open");
            ...
            $(".tab-links-mobile ul li").on("click", function () {
                ...
                $(".tab-links-mobile ul").slideUp(), $(".drtext").text(e), $(this).toggleClass("open"), $(this).siblings("li").removeClass("open");
                var t = $(this).children("a").attr("href");
                return (
                    $(t).siblings("div.tab-detail").hide(),
                    $(t).show(),
            ...
            $(".mobile-select ul li").on("click", function () {
                var e = $(this).find("a").text();
                $(".drtext-c").text(e), $(this).toggleClass("open"), $(this).siblings("li").removeClass("open");
                var t = $(this).children("a").attr("href");
                return (
                    $(t).siblings("div.tab-detail").hide(),
                    $(t).show(),
            ...
            $(window).width() < 960 &&
                $(".mainnav > ul > li:has(>ul)").on("click", function () {
                    $(this).find(">ul").slideToggle(), $(this).siblings("li:has(>ul)").find(">ul").hide();
                }),
            $(".mobilemenu_btn").on("click", function () {
                $(".mainnav").slideToggle(), $(".mainnav ul li ul").is(":visible") && $(".mainnav ul li ul").slideUp();
            }),
            ...
            $(window).scroll(function () {
                $(this).scrollTop() > 20 ? $("body").addClass("sticky") : $("body").removeClass("sticky");
            }),
            $(this).scrollTop() > 20 ? $("body").addClass("sticky") : $("body").removeClass("sticky");
    }),
    $(function () {
...
function autoscroll() {
    ...
    e >= MAX_TOP ? ((e = MAX_TOP), (dir = -1)) : e <= MIN_TOP && ((e = MIN_TOP), (dir = 1)), $(window).scrollTop(e), window.setTimeout(autoscroll, 100);
}
function wordTrim(e, t, i) {
    if (e.length <= t) return e;
    for (var s = e.split(" "), o = s[0].length, n = 1; n < s.length && !(o == t || o + s[n].length + 1 > t); n++) o += s[n].length + 1;
...
$(document).ready(function (e) {
    ...
    $("div.first-sub").hover(function () {
        ...
        $("#secondsub-" + e).toggleClass("active-link"), $(".right-column-wrap > div.submenu-change-default:nth-of-type(1)").toggleClass("hide-default");
    }),
    $("div.submenu-change").hover(function () {
        $(this).toggleClass("active-link"), $(".right-column-wrap > div.submenu-change-default:nth-of-type(1)").toggleClass("hide-default");
    }),
    ...
    $(".contact-tabs ul li a").on("click", function () {
        $(this).parent("div").parent("li").toggleClass("open"), $(this).parent("div").parent("li").siblings("li").removeClass("open");
        var e = $(this).attr("href");
        return $(e).siblings("div.tab-detail").hide(), $(e).show(), !1;
    }),
    (function (e) {
    ...
    (function (e, t) {
        ...
        var i,
            ...
            l = t
                ...
                .join(" "),
            d = t.extend({ hashTracking: !0, closeOnConfirm: !0, closeOnCancel: !0, closeOnEscape: !0, closeOnOutsideClick: !0, modifier: "" }, e.REMODAL_GLOBALS && e.REMODAL_GLOBALS.DEFAULTS),
            c = { CLOSING: "closing", CLOSED: "closed", OPENING: "opening", OPENED: "opened" },
            p = { CONFIRMATION: "confirmation", CANCELLATION: "cancellation" },
            u = void 0 !== (i = document.createElement("div").style).animationName || void 0 !== i.WebkitAnimationName || void 0 !== i.MozAnimationName || void 0 !== i.msAnimationName || void 0 !== i.OAnimationName,
        ...
        function f(e) {
            ...
            for (n = n.split(", "), a = a.split(", "), r = r.split(", "), o = 0, i = n.length, t = Number.NEGATIVE_INFINITY; o < i; o++) (s = parseFloat(n[o]) * parseInt(r[o], 10) + parseFloat(a[o])) > t && (t = s);
            return s;
        }
        function m() {
        ...
        function v() {
            if (!h) {
                var e,
                    ...
                    s = t("html"),
                    o = $("is-locked");
                s.hasClass(o) && ((i = t(document.body)), (e = parseInt(i.css("padding-right"), 10) - m()), i.css("padding-right", e + "px"), s.removeClass(o));
            }
        }
        function g(e, t, i, s) {
            var o = $("is", t),
                n = [$("is", c.CLOSING), $("is", c.OPENING), $("is", c.CLOSED), $("is", c.OPENED)].join(" ");
            e.$bg.removeClass(n).addClass(o), e.$overlay.removeClass(n).addClass(o), e.$wrapper.removeClass(n).addClass(o), e.$modal.removeClass(n).addClass(o), (e.state = t), !i && e.$modal.trigger({ type: t, reason: s }, [{ reason: s }]);
        }
        function b(e, i, s) {
            var o = 0,
                n = function (e) {
        ...
        function w() {
            ...
            if (o) {
                ...
                i && i.length && (e = t[n].lookup[i.data(n)]) && e.settings.hashTracking && e.open();
        ...
        function k(e, i) {
            ...
            (o.settings = t.extend({}, d, i)),
                ...
                (o.$modal = e.addClass(a + " " + $("is-initialized") + " " + o.settings.modifier + " " + $("is", c.CLOSED)).attr("tabindex", "-1")),
                (o.$wrapper = t("<div>")
                    .addClass($("wrapper") + " " + o.settings.modifier + " " + $("is", c.CLOSED))
                    .hide()
                    .append(o.$modal)),
                s.append(o.$wrapper),
                o.$wrapper.on("click." + a, "[data-" + n + '-action="close"]', function (e) {
                    e.preventDefault(), o.close();
                }),
                o.$wrapper.on("click." + a, "[data-" + n + '-action="cancel"]', function (e) {
                    e.preventDefault(), o.$modal.trigger(p.CANCELLATION), o.settings.closeOnCancel && o.close(p.CANCELLATION);
                }),
                o.$wrapper.on("click." + a, "[data-" + n + '-action="confirm"]', function (e) {
                    e.preventDefault(), o.$modal.trigger(p.CONFIRMATION), o.settings.closeOnConfirm && o.close(p.CONFIRMATION);
                }),
                o.$wrapper.on("click." + a, function (e) {
                    t(e.target).hasClass($("wrapper")) && o.settings.closeOnOutsideClick && o.close();
                });
        }
        (k.prototype.open = function () {
            ...
            i.state !== c.OPENING &&
                i.state !== c.CLOSING &&
                ((e = i.$modal.attr("data-" + n + "-id")) && i.settings.hashTracking && ((o = t(window).scrollTop()), (location.hash = e)),
                s && s !== i && y(s),
                (s = i),
                (function () {
                    if (!h) {
                        var e,
                            ...
                            s = t("html"),
                            o = $("is-locked");
                        s.hasClass(o) || ((i = t(document.body)), (e = parseInt(i.css("padding-right"), 10) + m()), i.css("padding-right", e + "px"), s.addClass(o));
                    }
                })(),
            ...
            (k.prototype.close = function (e) {
                ...
                i.state !== c.OPENING &&
                    i.state !== c.CLOSING &&
                    (i.settings.hashTracking && i.$modal.attr("data-" + n + "-id") === location.hash.substr(1) && ((location.hash = ""), t(window).scrollTop(o)),
                    b(
                        function () {
                            g(i, c.CLOSING, !1, e);
                        },
                        function () {
                            i.$bg.removeClass(i.settings.modifier), i.$overlay.removeClass(i.settings.modifier).hide(), i.$wrapper.hide(), v(), location.reload(), g(i, c.CLOSED, !1, e);
                        },
                        i
                    ));
            }),
            ...
            (k.prototype.destroy = function () {
                ...
                y(this),
                    ...
                    0 ===
                        t.grep(e, function (e) {
                            return !!e;
                        }).length && (this.$overlay.remove(), this.$bg.removeClass($("is", c.CLOSING) + " " + $("is", c.OPENING) + " " + $("is", c.CLOSED) + " " + $("is", c.OPENED)));
            }),
            (t[n] = { lookup: [] }),
            (t.fn[n] = function (e) {
                var i, s;
                return (
                    this.each(function (o, a) {
                        null == (s = t(a)).data(n) ? ((i = new k(s, e)), s.data(n, i.index), i.settings.hashTracking && s.attr("data-" + n + "-id") === location.hash.substr(1) && i.open()) : (i = t[n].lookup[s.data(n)]);
                    }),
                    i
                );
            }),
                                ...
                                ? ("string" == typeof o || o instanceof String) &&
                                  (o = (function (e) {
                                      var t,
                                          ...
                                          o,
                                          n = {};
                                      for (o = 0, i = (t = (e = e.replace(/\s*:\s*/g, ":").replace(/\s*,\s*/g, ",")).split(",")).length; o < i; o++)
                                          (t[o] = t[o].split(":")),
                                              ("string" == typeof (s = t[o][1]) || s instanceof String) && (s = "true" === s || ("false" !== s && s)),
    ...
    (jQuery.fn.nTicker = function (e) {
        return (
            ...
            this.each(function () {
                ...
                o.wrap('<div id="' + n + '"></div>'), o.css({ margin: "0 !important", padding: "0 !important" });
                var a = !0,
                    r = o.offset().left,
                    l = 1;
                o.children("li.tick-clones").remove(), o.addClass("newsticker"), o.wrap("<div class='mask'></div>");
                for (var d = o.parent().wrap("<div class='tickercontainer'></div>"), c = o.children("li"), p = d.outerWidth(!0); l < p; )
                    (l = 1),
                ...
                function u(e, s) {
                    o.animate({ left: "-=" + e }, s, "linear", function () {
                        o.children("li:first").appendTo(o), o.css("left", 0), (t = o.children("li:first").outerWidth(!0)), (i = (s / e) * t), a && u(t, i);
                    });
                }
                function h() {
                    o.hover(f, m);
                ...
                if ((o.width(l), o.height(o.parent().height()), (t = o.children("li:first").outerWidth(!0)), (i = (t / e.speed) * 1e3), u(t, i), e.pause && h(), e.buttons)) {
                    s('<ul class="ticker-controls"><li class="prev nthriveticker nthriveticker-left"></li><li class="pause nthriveticker nthriveticker-pause"></li><li class="next nthriveticker nthriveticker-right"></li></ul>').insertAfter(
                        d
                    ),
                        s("body").on("click", "#" + n + " .ticker-controls > .pause", function () {
                            if (!a) return !1;
                            s(this).toggleClass("pause nthriveticker-pause play nthriveticker-play"), o.unbind("mouseenter mouseleave"), (a = !1);
                        }),
                        s("body").on("click", "#" + n + " .ticker-controls > .play", function () {
                            if (a) return !1;
                            s(this).toggleClass("pause nthriveticker-pause play nthriveticker-play"), (a = !0), h();
                            var e = o.offset().left + o.children("li:first").outerWidth(!0) - r;
                            u(e, (i / t) * e);
                        });
                    var v = !1;
                    s("body").on("click", "#" + n + " .ticker-controls > .next", function () {
                        if (a) return s("#" + n + " .ticker-controls > .pause").toggleClass("pause nthriveticker-pause play nthriveticker-play"), void (a = !1);
                        if (v) return !1;
                        var t = o.children("li:first").outerWidth(!0),
                            i = (t / e.speed) * 1e3;
                        (v = !0),
                            o.stop(!0, !0).animate({ left: "-=" + t }, i, "linear", function () {
                                o.children("li:first").appendTo(o), o.css("left", 0), (v = !1);
                            });
                    }),
                        s("body").on("click", "#" + n + " .ticker-controls > .prev", function () {
                            if (a) return s("#" + n + " .ticker-controls > .pause").toggleClass("pause nthriveticker-pause play nthriveticker-play"), void (a = !1);
                            if (v) return !1;
                            var t = o.children("li:last").outerWidth(!0);
                            o.css("left", "-" + t + "px"), o.children("li:last").prependTo(o);
                            var i = (t / e.speed) * 1e3;
                            (v = !0),
                                o.stop(!0, !0).animate({ left: "+=" + t }, i, "linear", function () {
                                    v = !1;
    ...
    $("#back").on("keyup", function (e) {
        9 === e.keyCode && ($(this).parent("div").parent("div").parent("div.l-double-width").animate({ left: "0" }, "fast"), $("#form-sec-1 input").filter(":first").focus());
    }),
    $("#form-next").click(function () {
        $("#next-button").attr("aria-hidden", "true"),
            $("#next-button").addClass("hidden"),
            $("input#question-field").valid()
                ? ($(this).parent("div").parent("div").parent("div").parent("div.l-double-width").animate({ left: "-100%" }, "fast"), $("#form-sec-2 input").filter(":first").focus())
                : $("input.error").filter(":first").focus();
    }),
    $("#question-field").on("keydown", function (e) {
        39 === e.keyCode && $("#form-next").focus(), 37 == e.keyCode && $("a:focus").prev().focus();
    }),
    $("#form-next").on("keydown", function (e) {
        if (
            ...
            return $("#next-button").attr("aria-hidden", "true"), $("#next-button").addClass("hidden"), ev.preventDefault(), !1;
        39 === e.keyCode && $("#privacy-policy-footer").focus();
    }),
    $("#privacy-policy-footer").on("focus", function () {
        $("#question-field").removeClass("error").next("label").attr("id", "question-field").removeClass("error").addClass("label-focus"), $("#next-button").attr("aria-hidden", "true"), $("#next-button").addClass("hidden");
    }),
    $(document).ready(function () {
        $("#footer-form").validate({
            rules: { first_name: { required: !0, minlength: 3 }, last_name: { required: !0, minlength: 3 }, email: { required: !0, email: !0 }, General_Question: { required: !0, minlength: 5 } },
            messages: {
                first_name: { required: "Please enter your first name", minlength: "Your first name must consist of at least 3 characters" },
                last_name: { required: "Please enter your last name", minlength: "Your last name must consist of at least 3 characters" },
                email: "Please enter a valid email address",
                General_Question: { required: "Please enter your question", minlength: "Your question must consist of at least 5 characters" },
            },
        });
    }),
    $(document).ready(function () {
        $("input[type='tel']").attr("autocomplete", "none"),
            $("form :input").focus(function () {
                $(this).closest(".input-wrap").addClass("valid-group").children("label.label-focus").removeClass("label-focus").addClass("label-blur");
            }),
            $('form input:not(input[type="tel"])').blur(function () {
                $(this).parent().closest("label.label-blur").removeClass("label-blur").addClass("label-focus");
            }),
        ...
        var e = $("#secondary-nav"),
            ...
            o = $("#main-nav");
        function n() {
            $(window).width() < 840 ? (t.append(e), o.prepend(s)) : (i.append(e), t.before(s));
        }
        $("header").append('<div class="wheel-toggle btn-anim"><a href="#wheel-mobile" class="block" tabindex="-1"><span>+</span></a></div>'),
            n(),
    ...
    $(function () {
        var e = $(".table-body.rev-table.l-list-two-col.text-white > li:first-child > p").html(),
            t = $(".table-body.rev-table.l-list-two-col.text-white > li:last-child > p").html(),
            i = !1;
        function s() {
            !i &&
                $(window).width() < 840 &&
                ($(".table-body.rev-table.bg-ffffff > li:first-child ").prepend('<p class="desktop-hide">' + e + "</p>"), $(".table-body.rev-table.bg-ffffff > li:last-child").prepend('<p class="desktop-hide">' + t + "</p>"), (i = !0));
        }
        $(window).resize(s), s();
    });
    $(document).ready(function () {
